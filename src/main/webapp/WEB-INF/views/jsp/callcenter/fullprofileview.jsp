<%-- 
    ...
    Created on : Sep 9, 2015, 10:04:18 AM
    Author     : Isuru
--%>
        ...
        <div id="main" role="main">
            ...
            <div id="ribbon">
                ...
                <ol id="view_bc" class="breadcrumb">
                    <li><a href="${pageContext.servletContext.contextPath}/calllogsearch">Call Center Management</a></li><li>View Profile</li>
                </ol>
            </div>
            <!-- END RIBBON -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-10">
                            <footer style="background-color: #ffffff">
                                <a id="back_btn" type="button" class="btn btn-default" href="${pageContext.servletContext.contextPath}/callcenter/recievingcall?cli=${telephone}&datetime=${clidatetime}&isdataset=${isdataset}&title=${title}&ini=${ini}&p_name=${p_name}&l_name=${l_name}&name_in_full=${name_in_full}&accountId=${accountId}">Back to Call log</a>

    ...
    <body class="">
        ...
        <div id="main" role="main">
            ...
            <div id="ribbon">
                ...
                <!-- breadcrumb -->
                <ol class="breadcrumb">
                    <li><a href="${pageContext.servletContext.contextPath}/case/search">Ticket Management</a></li><li>Search Ticket</li>
                    <!-- end breadcrumb -->
                </ol>
            ...
            <div id="content">	
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-5 col-md-12 col-lg-12"  style="height: 25px;">
                        <!--                        <ul id="sparks" class="">
                                                    <a href="${pageContext.request.contextPath}/case/create" class="btn btn-primary">Create New Case</a>
                                                </ul>-->
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <!-- NEW COL START -->
                    <form:form novalidate="novalidate" method="get" action="${pageContext.request.contextPath}/case/searched" commandName="casesearch">
                            ...
                            <div class="input-group input-group-sm ">
                                <div class="input-group-btn">
                                    <form:select name = "searchoption" path="searchoption" class="btn btn-default dropdown-toggle" data-toggle="dropdown" onchange="clearTable()">
                                        <form:option value="nic"  >NIC</form:option>
                                        <form:option value="caseId" >Ticket ID</form:option>
                                        <form:option value="caseCallLogId" >Call Log ID</form:option>
                                        <form:option value="customervisitId" >Customer Visit ID</form:option>
                                            <!--                                        <option value="LASTNAME">First Name</option>
                                        ...
                                        <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                                            <thead>			                
                                                <tr>
                                                    ...
                                                    <th data-class="expand"><i class=""></i> Ticket Type</th>

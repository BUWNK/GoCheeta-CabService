            ...
            <div id="content">	
                <div class="row">
                    <div class="col-xs-12 col-sm-5 col-md-12 col-lg-12">
                        <ul id="sparks" class="">
                            <a href="../client/create" class="btn btn-primary">Create New Case</a>
                        </ul>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <!-- NEW COL START -->
                    <form novalidate="novalidate" method="post" action="search">
                        <article class="col-sm-12 col-md-12 col-lg-6">

                            <div class="input-group input-group-lg ">
                                <div class="input-group-btn">
                                    <select name = "searchcri" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                                        <option value="FIRSTNAME">NIC</option>
                                        <option value="LASTNAME">First Name</option>
                                        <option value="LASTNAME">Last Name</option>
                                        <option value="EMAIL">Email</option>
                                    </select>
                                </div>
                                <input class="form-control input-lg" type="text" placeholder="Search" id="search-project" name="searchdata">
                                <div class="input-group-btn">

<%-- 
    ...
    Created on : Jan 8, 2016, 9:22:47 AM
    Author     : Isuru
--%>
    ...
    <body class="">
        ...
        <div id="main" role="main">
            ...
            <div id="content">
                ...
                <form:form novalidate="novalidate" method="post" action="${pageContext.servletContext.contextPath}/customervisit/fullprofile/search" commandName="accountForm" autocomplete="off">
                    <div class="row">
                        <!-- NEW COL START -->
                                            ...
                                            <tbody>
                                                <c:if test="${accountForm.searchData != null}">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <form:form novalidate="novalidate" method="post" action="${pageContext.servletContext.contextPath}/customervisit/fullprofileview" commandName="accountForm">
            ...
            <c:if test="${accountForm.searchData == null}">
                <div class="col-xs-12 col-sm-5 col-md-12 col-lg-12">
                    <ul id="sparks" class="">
                        <a id="back_btn" type="button" class="btn btn-default" href="${pageContext.servletContext.contextPath}/customervisit/create/view">Back to Customer Visit log</a>
                    </ul>
                </div>
            </c:if>
        </div>

<%-- 
    Document   : fullprofileview
    Created on : Jan 8, 2016, 9:23:38 AM
    Author     : Isuru
--%>
        ...
        <div id="main" role="main">
            ...
            <div id="ribbon">
                ...
                <ol id="view_bc" class="breadcrumb">
                    <li><a href="${pageContext.servletContext.contextPath}/customervisit/search">Call Center Management</a></li><li>View Profile</li>
                </ol>
            </div>
            <!-- END RIBBON -->
            ...
            <div id="content">
                ...
                <form:form class="smart-form" commandName="accountForm"  id="customerVisitForm"  action="${pageContext.servletContext.contextPath}/customervisit/customervisit" method="POST">
                    <form:input type="text"  path="jasonobject" value="${JASONOBJ}"/>
                </form:form>
                                        ...
                                        <c:if test="${accountForm.searhDataBean != null && accountForm.searhDataBean.account_category == 0}">
                                            <div class="panel panel-default">
                                                <div class="panel-heading" style="background-color: #F2F1F1">
                                                    <h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" class="collapsed"> <i class="fa fa-lg fa-angle-up pull-right"></i> <i class="fa fa-lg fa-angle-up pull-right"></i> Personal Details </a></h4>
                                                </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-xs-4">
                                                                <section>
                                                                    ...
                                                                    <label class="input">
                                                                        <input type="text" disabled="disabled" id="current_balance" placeholder="Current Balance"/>
                                                                    </label>
                                                                </section>
                                                            </div>
                                                            <div class="col-xs-1"></div>
                                                                        ...
                                                                        <c:if test="${accountForm.searhDataBean != null && accountForm.searhDataBean.stakeHolderSavingsBeans.size() > 0}">
                                                                            <c:forEach var="savings" items="${accountForm.searhDataBean.stakeHolderSavingsBeans}">
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <a href="javascript:void(0);" onclick="javascript:setSavingValues('${savings.savings_id_view}')" class="fa fa-eye" style="text-decoration:none;"/>
                                                                                        <div id="${savings.savings_id_view}" style="display: none;">${savings.toString()}</div>
                                                                                    </td>
                                                                                </tr>
                                                                            </c:forEach>
                                                                        </c:if>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-xs-4">
                                                                <section>
                                                                    ...
                                                                    <label class="input">
                                                                        <input type="text" disabled="disabled" id="mf_total_offered_amount"  placeholder="Total Offered Amount"/>
                                                                    </label>
                                                                </section>
                                                            </div>
                                                            <div class="col-xs-1"></div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-xs-4">
                                                                <section>
                                                                    ...
                                                                    <label class="input">
                                                                        <input type="text" disabled="disabled" id="mf_total_arrears_amount" placeholder="Total Arrears Amount"/>
                                                                    </label>
                                                                </section>
                                                            </div>
                                                            <div class="col-xs-1"></div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-xs-4">
                                                                <section>
                                                                    ...
                                                                    <label class="input">
                                                                        <input type="text" disabled="disabled" id="mf_outstanding_amount" placeholder="Outstanding Amount"/>
                                                                    </label>
                                                                </section>
                                                            </div>
                                                            <div class="col-xs-2"></div>
                                                                            ...
                                                                            <c:forEach var="microfinace" items="${accountForm.searhDataBean.customerLoanBeans}">
                                                                                <c:if test="${microfinace.module_code == 'MF'}">
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>
                                                                                            <a href="javascript:void(0);" onclick="javascript:setMicroFinanceValues('${microfinace.loan_id_view}')" class="fa fa-eye" style="text-decoration:none;"/>
                                                                                            <div id="${microfinace.loan_id_view}" style="display: none;">${microfinace.toString()}</div>
                                                                                        </td>
                                                                                    </tr>
                                                                                </c:if>
                                                                            </c:forEach>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-xs-4">
                                                                <section>
                                                                    <label class="label">Total Offered Amount</label>
                                                                    <label class="input">
                                                                        <input type="text" disabled="disabled" id="cr_total_offered_amount"  placeholder="Total Offered Amount"/>
                                                                    </label>
                                                                </section>
                                                            </div>
                                                            <div class="col-xs-1"></div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-xs-4">
                                                                <section>
                                                                    <label class="label">Total Arrears Amount</label>
                                                                    <label class="input">
                                                                        <input type="text" disabled="disabled" id="cr_total_arrears_amount" placeholder="Total Arrears Amount"/>
                                                                    </label>
                                                                </section>
                                                            </div>
                                                            <div class="col-xs-1"></div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-xs-4">
                                                                <section>
                                                                    <label class="label">Outstanding Amount</label>
                                                                    <label class="input">
                                                                        <input type="text" disabled="disabled" id="cr_outstanding_amount" placeholder="Outstanding Amount"/>
                                                                    </label>
                                                                </section>
                                                            </div>
                                                            <div class="col-xs-2"></div>
                                                                            ...
                                                                            <c:forEach var="credit" items="${accountForm.searhDataBean.customerLoanBeans}">
                                                                                <c:if test="${credit.module_code == 'CR'}">
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>
                                                                                            <a href="javascript:void(0);" onclick="javascript:setCreditValues('${credit.loan_id_view}')" class="fa fa-eye" style="text-decoration:none;"/>
                                                                                            <div id="${credit.loan_id_view}" style="display: none;">${credit.toString()}</div>
                                                                                        </td>
                                                                                    </tr>
                                                                                </c:if>
                                                                            </c:forEach>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-xs-4">
                                                                <section>
                                                                    <label class="label">Total Offered Amount</label>
                                                                    <label class="input">
                                                                        <input type="text" disabled="disabled" id="pw_total_offered_amount"  placeholder="Total Offered Amount"/>
                                                                    </label>
                                                                </section>
                                                            </div>
                                                            <div class="col-xs-1"></div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-xs-4">
                                                                <section>
                                                                    <label class="label">Total Arrears Amount</label>
                                                                    <label class="input">
                                                                        <input type="text" disabled="disabled" id="pw_total_arrears_amount" placeholder="Total Arrears Amount"/>
                                                                    </label>
                                                                </section>
                                                            </div>
                                                            <div class="col-xs-1"></div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-xs-4">
                                                                <section>
                                                                    <label class="label">Outstanding Amount</label>
                                                                    <label class="input">
                                                                        <input type="text" disabled="disabled" id="pw_outstanding_amount" placeholder="Outstanding Amount"/>
                                                                    </label>
                                                                </section>
                                                            </div>
                                                            <div class="col-xs-2"></div>
                                                                            ...
                                                                            <c:forEach var="pawning" items="${accountForm.searhDataBean.customerLoanBeans}">
                                                                                <c:if test="${pawning.module_code == 'PW'}">
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>
                                                                                            <a href="javascript:void(0);" onclick="javascript:setPawningValues('${pawning.loan_id_view}')" class="fa fa-eye" style="text-decoration:none;"/>
                                                                                            <div id="${pawning.loan_id_view}" style="display: none;">${pawning.toString()}</div>
                                                                                        </td>
                                                                                    </tr>
                                                                                </c:if>
                                                                            </c:forEach>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-10">
                            <footer style="background-color: #ffffff">
                                <a id="back_btn" type="button" class="btn btn-default" id="btnBackButon" href="${pageContext.servletContext.contextPath}/customervisit/searchprofile">Back to Customer Visit log</a>

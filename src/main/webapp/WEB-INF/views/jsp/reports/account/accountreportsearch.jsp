    ...
    <body class="">
        ...
        <div id="main" role="main">
            ...
            <div id="content">
                ...
                <form:form novalidate="novalidate" method="post" action="${pageContext.servletContext.contextPath}/report/account/search" commandName="accountForm" autocomplete="off">
                    <div class="row">
                        <!-- NEW COL START -->
                                            ...
                                            <tbody>
                                                <c:if test="${accountForm.searchData != null}">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <form:form novalidate="novalidate" method="post" action="${pageContext.servletContext.contextPath}/report/account/search/view" commandName="accountForm">

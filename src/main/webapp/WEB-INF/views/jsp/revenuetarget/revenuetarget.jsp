                                    ...
                                    <div id="bootstrap-wizard-1" class="col-sm-12">
                                        ...
                                        <div class="form-bootstrapWizard">
                                            <ul class="bootstrapWizard form-wizard">
                                                <li class="active" data-target="#step1" id="step01">
                                                    <a href="#tab1" data-toggle="tab"> <span class="step"  >1</span> <span class="title">Organization</span> </a>
                                                </li>
                                                <li data-target="#step2" id="step02">
                                                    <a href="#tab2" data-toggle="tab"> <span class="step"  >2</span> <span class="title">Regional</span> </a>
                                                </li>
                                                <li data-target="#step3" id="step03">
                                                    <a href="#tab3" data-toggle="tab"> <span class="step"  >3</span> <span class="title">Branch</span> </a>
                                                </li>
                                                <li data-target="#step4" id="step04">
                                                    <a href="#tab4" data-toggle="tab"> <span class="step"  >4</span> <span class="title">Team Revenue</span> </a>
                                                </li>
                                                <li data-target="#step5" id="step05">
                                                    <a href="#tab5" data-toggle="tab"> <span class="step"  >5</span> <span class="title">Team Activity</span> </a>
                                                </li>
                                                <li data-target="#step6"  id="step06">
                                                    <a href="#tab6" data-toggle="tab"> <span class="step" >6</span> <span class="title">Finish</span> </a>
                                                </li>
                                            </ul>
...
//                $('.bootstrapWizard form-wizard li.active').removeClass('active');
                ...
                'columnDefs': [
                    {
                        ...
                        'render': function (data, type, full, meta) {
                            ...
                            count++;
                            return '<input type="text"  name="name' + count + '" value="' + 0 + '" onchange="validate()" > <div id="errorContainer"></div>';
                        }
                    },
                    {
                        "targets": [0],
                        ...
                        success: function (response) {
                            ...
                            if (response.CODE === "SUCCESS") {
                                if (response.remaning !== 0) {
                                    $('#msg_dev').html('<div class="alert alert-info"><strong>Info!</strong> Remaining amount to be shared among the Region of current Organization is ' + $.number(response.remaning) + '</div>  ');
                                    window.scrollTo(0, 0);
                                } else {
                                ...
                                //                                $('#msg_dev2').html('<div class="alert alert-warning"><strong>Warning!</strong> ' + response.MESSAGE + '</div>  ');
...
//                $('#dt_basic input:text').click(function () {
////                    alert(parseInt($(this).val().replace(/,/g, "")));
...
//
//                });
//                $('#dt_basic input:text').focusout(function () {
                ...
                if ($valid) {
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            if (response.CODE === "SUCCESS") {
                                if (response.remaning !== 0) {
                                    $('#msg_dev').html('<div class="alert alert-info"><strong>Info!</strong> Remaining amount to be shared among the Branches of current Region is ' + $.number(response.remaning) + '</div>  ');
                                    window.scrollTo(0, 0);
                                } else {
                ...
                if ($valid) {
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            response = JSON.parse(response);
                            if (response.CODE === "SUCCESS") {
                                $('#msg_dev4').html('<div class="alert alert-success"><strong>Success!</strong> Record Sucessfully Updated</div>  ');
//                                window.scrollTo(0, 0);
                            } else {
                                $('#msg_dev4').html('<div class="alert alert-warning"><strong>Warning!</strong> Invalid Count Please Check your count</div>  ');
//                                window.scrollTo(0, 0);
                            }
                        },
                        error: function () {
...
//                            window.scrollTo(0, 0);
            ...
            function validationDatatbelSix() {
                ...
                jQuery.validator.addMethod("amountvalidation", function () {
                    if ($("#barnchamount").val() >= parseInt($("#branchgroupamount").val())) {
...
//                getBranchGroupActivityMemberDetails();
            ...
            var table9 = $('#dt_basic9').DataTable({
                ...
                "sPaginationType": "full_numbers",
                "sDom": "<'dt-toolbar'<'col-sm-4 col-xs-6 hidden-xs'i><'col-xs-12 col-sm-6'r>>" +
                        "t" + "<'dt-toolbar-footer'<'col-sm-4 col-xs-6 hidden-xs'l><'col-xs-12 col-sm-8'p>>", //                "autoWidth": true,

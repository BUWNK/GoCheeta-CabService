            ...
            <div id="content">
                ...
                <form:form id="accountCreate" novalidate="novalidate" class="smart-form" commandName="accountForm" action="${pageContext.servletContext.contextPath}/account/create" autocomplete="off" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-3">
                            <section>
                                ...
                                <label class="select">
                                    <form:select id="customer_category"  path="customer_category" onchange="categoryOnChange('${pageContext.servletContext.contextPath}')" items="${customerCategoryList}" value="0"/>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-8">
                            <footer style="background-color: #ffffff">
                                ...
                                <form:button  type="button" id="checkPointOneSaveAndMove" disabled="${avn_create}" class="btn btn-default">Create & Move Next</form:button>
                                <form:button type="button" id="checkPointOneSave" disabled="${avn_create}" class="btn btn-default">Create</form:button>
                            </footer>
                        </div>
                        <div class="col-xs-2"></div>
                    </div>
                                            ...
                                            <div id="collapseOne" class="panel-collapse collapse">
                                                <div class="panel-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xs-10">
                                                            <section>
                                                                ...
                                                                <label class="input">
                                                                    <form:input type="text" id="name_in_full" path="name_in_full" placeholder="Name in Full" maxlength="100" value="${AccountUpdateList.name_in_full}"/>
                                                                </label>
                                                            </section>
                                                        </div>
                                                        <div class="col-xs-1"></div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xs-4">
                                                            <section>
                                                                ...
                                                                <label class="input">
                                                                    <form:input type="text" id="initials" path="initials" placeholder="Initials" readonly="true" value="${AccountUpdateList.initials}"/>
                                                                </label>
                                                            </section>
                                                        </div>
                                                        <div class="col-xs-2"></div>
                                                        <div class="col-xs-4">
                                                            <section>
                                                                ...
                                                                <label class="input">
                                                                    <form:input type="text" id="last_name" path="last_name" placeholder="Last Name" maxlength="20" readonly="true" value="${AccountUpdateList.last_name}"/>
                                                                </label>
                                                            </section>
                                                        </div>
                                                        <div class="col-xs-1"></div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xs-4">
                                                            <section>
                                                                ...
                                                                <label class="input">
                                                                    <form:input type="text" id="preferred_name" path="preferred_name" placeholder="Preferred Name" maxlength="20" value="${AccountUpdateList.preferred_name}"/>
                                                                </label>
                                                            </section>
                                                        </div>
                                                        <div class="col-xs-2"></div>
                                                        ...
                                                        <div class="col-xs-4">
                                                            <section>
                                                                ...
                                                                <label class="input"> <i class="icon-prepend fa fa-calendar"></i>
                                                                    <form:input type="text" class="form-control" id="date_of_birth" path="date_of_birth" placeholder="Date of Birth" readonly="true" value="${AccountUpdateList.date_of_birth}"/>
                                                                </label>
                                                            </section>
                                                        </div>
                                                        <div class="col-xs-2"></div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xs-4">
                                                            <section>
                                                                ...
                                                                <label class="input">
                                                                    <form:input id="mothers_maiden_name" path="mothers_maiden_name" placeholder="Mothers Maden Name" maxlength="100" value="${AccountUpdateList.mothers_maiden_name}"/>
                                                                </label>
                                                            </section>
                                                        </div>
                                                        <div class="col-xs-2"></div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xs-10">
                                                            <footer style="background-color: #ffffff">
                                                                <form:button type="button" id="checkPointTwoSaveAndMove" disabled="${avn_create}" class="btn btn-default">Save & Move Next</form:button>
                                                                <form:button type="button" id="checkPointTwoSave" disabled="${avn_create}" class="btn btn-default">Save</form:button>
                                                            </footer>
                                                        </div>
                                                        <div class="col-xs-1"></div>
                                                    </div>
                                            ...
                                            <div id="collapseEight" class="panel-collapse collapse">
                                                <div class="panel-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xs-10">
                                                            <footer style="background-color: #ffffff">
                                                                <form:button type="button" id="checkPointNineSaveAndMove" disabled="${avn_create}" class="btn btn-default">Save & Move Next</form:button>
                                                                <form:button type="button" id="checkPointNineSave" disabled="${avn_create}" class="btn btn-default">Save</form:button>
                                                            </footer>
                                                        </div>
                                                        <div class="col-xs-1"></div>
                                                    </div>
                                            ...
                                            <div id="collapseTwo" class="panel-collapse collapse">
                                                <div class="panel-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xs-10">
                                                            <footer style="background-color: #ffffff">
                                                                <form:button id="checkPointThree" type="button" disabled="${avn_create}" class="btn btn-default">Save & Move Next</form:button>
                                                                <form:button id="address_add_btn" type="button" disabled="${avn_create}" class="btn btn-default">Save & Add Another</form:button>
                                                            </footer>
                                                        </div>
                                                        <div class="col-xs-1"></div>
                                                    </div>
                                            ...
                                            <div id="collapseNine" class="panel-collapse collapse">
                                                <div class="panel-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xs-10">
                                                            <footer style="background-color: #ffffff">
                                                                <form:button type="button" id="checkPointTenSaveAndMove" disabled="${avn_create}" class="btn btn-default">Save & Move Next</form:button>
                                                                <form:button type="button" id="checkPointTenSave" disabled="${avn_create}" class="btn btn-default">Save</form:button>
                                                            </footer>
                                                        </div>
                                                        <div class="col-xs-1"></div>
                                                    </div>
                                            ...
                                            <div id="collapseThree" class="panel-collapse collapse">
                                                <div class="panel-body no-padding">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xs-10">
                                                            <footer style="background-color: #ffffff">
                                                                <form:button id="checkPointFour" type="button" disabled="${avn_create}" class="btn btn-default">Save & Move Next</form:button>
                                                                <form:button id="education_add_btn" type="button" disabled="${avn_create}" class="btn btn-default">Save & Add Another</form:button>
                                                            </footer>
                                                        </div>
                                                        <div class="col-xs-1"></div>
                                                    </div>
                                            ...
                                            <div id="collapseFour" class="panel-collapse collapse">
                                                <div class="panel-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xs-10">
                                                            <footer style="background-color: #ffffff">
                                                                <form:button type="button" id="checkPointFiveSaveAndMove" disabled="${avn_create}" class="btn btn-default">Save & Move Next</form:button>
                                                                <form:button type="button" id="checkPointFiveSave" disabled="${avn_create}" class="btn btn-default">Save</form:button>
                                                            </footer>
                                                        </div>
                                                        <div class="col-xs-1"></div>
                                                    </div>
                                            ...
                                            <div id="collapseFive" class="panel-collapse collapse">
                                                <div class="panel-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xs-10">
                                                            <footer style="background-color: #ffffff">
                                                                <form:button id="checkPointSixSaveAndMove" type="button" disabled="${avn_create}" class="btn btn-default">Save & Move Next</form:button>
                                                                <form:button type="button" id="checkPointSixSave" disabled="${avn_create}" class="btn btn-default">Save</form:button>
                                                            </footer>
                                                        </div>
                                                        <div class="col-xs-1"></div>
                                                    </div>
                                            ...
                                            <div id="collapseSix" class="panel-collapse collapse">
                                                <div class="panel-body no-padding">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xs-10">
                                                            <footer style="background-color: #ffffff">
                                                                <form:button id="checkPointSeven" type="button" disabled="${avn_create}" class="btn btn-default">Save & Move Next</form:button>
                                                                <form:button id="dependent_add_btn" type="button" disabled="${avn_create}" class="btn btn-default">Save & Add Another</form:button>
                                                            </footer>
                                                        </div>
                                                        <div class="col-xs-1"></div>
                                                    </div>
                                            ...
                                            <div id="collapseEleven" class="panel-collapse collapse">
                                                <div class="panel-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xs-10">
                                                            <footer style="background-color: #ffffff">
                                                                <form:button type="button"  disabled="${avn_create}" id="checkPointElevenSaveAndMove" class="btn btn-default">Save & Move Next</form:button>
                                                                <form:button id="checkPointEleven" disabled="${avn_create}" type="button" class="btn btn-default">Save & Add Another</form:button>
                                                            </footer>
                                                        </div>
                                                        <div class="col-xs-1"></div>
                                                    </div>
                                            ...
                                            <div id="collapseSeven" class="panel-collapse collapse">
                                                <div class="panel-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xs-10">
                                                            <footer style="background-color: #ffffff">
                                                                <form:button type="button" id="checkPointEightSaveAndMove" disabled="${avn_create}" class="btn btn-default">Save & Move Next</form:button>
                                                                <form:button id="checkPointEight" type="button" disabled="${avn_create}" class="btn btn-default">Save</form:button>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-10">
                            <footer style="background-color: #ffffff">
                                <form:button type="submit" disabled="${avn_create}" class="btn btn-default">Save</form:button>

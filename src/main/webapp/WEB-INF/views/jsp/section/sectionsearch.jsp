<%-- 
    Document   : sectionsearch
    Created on : Nov 24, 2015, 2:54:10 PM
    Author     : Isuru
--%>
    ...
    <body class="">
        ...
        <div id="main" role="main">
            ...
            <div id="ribbon">
                <!-- breadcrumb -->
                <ol class="breadcrumb">
                    <li><a href="${pageContext.servletContext.contextPath}/case/search">Section Management</a></li><li>Search Section</li>
                    <!-- end breadcrumb -->
                </ol>   
            </div>
            <!-- END RIBBON -->
            ...
            <div id="content">	
                ...
                <div class="row">
                    ...
                    <!-- NEW COL START -->
                    <form:form novalidate="novalidate" method="get" action="${pageContext.request.contextPath}/case/searched" commandName="sectionsearch">
                            ...
                            <div class="input-group input-group-sm ">
                                <div class="input-group-btn">
                                    <form:select name = "searchoption" path="searchoption" class="btn btn-default dropdown-toggle" data-toggle="dropdown" onchange="clearTable()">
                                        <form:option value="sectionid"  >Section ID</form:option>
                                        <form:option value="sectiondes" >Section Description</form:option>
                                    </form:select>
                                </div>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                var search_table = $('#dt_basic').dataTable({
                    ...
                    "sAjaxSource": "${pageContext.servletContext.contextPath}section/searched",
                    "fnServerData": function (sSource, aoData, fnCallback) {
                        ...
                        $.ajax({
                            "dataType": 'json',
                            "type": "POST",
                            "url": "${pageContext.servletContext.contextPath}/section/searched",
                            "data": aoData,
                            "success": fnCallback
                        });
                    },

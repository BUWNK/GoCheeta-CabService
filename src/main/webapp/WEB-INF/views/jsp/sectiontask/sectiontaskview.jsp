<%-- 
    Document   : sectiontaskview
    Created on : Dec 3, 2015, 3:33:20 PM
    Author     : Isuru
--%>
    ...
    <body class="">
        ...
        <div id="main" role="main">
            ...
            <div id="ribbon">
                <!-- breadcrumb -->
                <ol class="breadcrumb">
                    <li> <a href="${pageContext.servletContext.contextPath}/">Section Task Management</a></li><li>View</li>
                    <!-- end breadcrumb -->
            </div>
            <!-- END RIBBON -->
            <!-- MAIN CONTENT -->
            <div id="content">
                ...
                <form:form class="smart-form" id="sectionsCreateForm" novalidate="novalidate" commandName="sectiontaskview" action="${pageContext.request.contextPath}/sections/create" method="post" >
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-3">
                            <section>
                                ...
                                <label class="select">
                                    <form:select id="sectionid" path="sectionid" disabled="true" items="${sectionList}"/><i></i>
                                </label>
                            </section>
                        </div>
                    ...
                    <div class="row" id="multibranchselect" style="display: ${multibranchdisplay};">
                        ...
                        <div class="col-xs-3">
                            <section>
                                ...
                                <label class="select">
                                    <form:select id="taskid" path="taskid" disabled="true" multiple="true" style="height:100px;" items="${notAssigneTask}"/>
                                </label>
                            </section>
                        </div>
                        <div class="col-xs-2">
                        ...
                        <div class="col-xs-3">
                            <section>
                                <label class="label" style="height:19px;"></label>
                                <label class="select">
                                    <form:select id="multitask" path="multitask" disabled="true" multiple="true" items="${assigneTask}"  style="height:100px;"/>
                                </label>
                            </section>
                        </div>
                        <div class="col-xs-2"></div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-10">
                            <footer style="background-color: #ffffff">
                                <button type="button" class="btn btn-primary" id ="pagesubmit" onclick="pageSubmit();">Save</button>  
                            </footer>
                        </div>
                        <div class="col-xs-1"></div>
                    </div>
                ...
                <script type="text/javascript">
                    function pageSubmit() {
                        ...
                        if ($("#sectionsCreateForm").valid()) {
                            ...
                            $.ajax({
                                type: "post",
                                url: "${pageContext.servletContext.contextPath}/sectiontask/addtask",
                                cache: false,

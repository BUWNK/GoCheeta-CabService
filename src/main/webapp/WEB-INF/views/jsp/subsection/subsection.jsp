<%-- 
    ...
    Created on : Nov 26, 2015, 9:01:31 AM
    Author     : Isuru
--%>
    ...
    <body class="">
        ...
        <div id="main" role="main">
            ...
            <div id="ribbon">
                <!-- breadcrumb -->
                <ol class="breadcrumb">
                    <li> <a href="${pageContext.servletContext.contextPath}/">Sub Section Management</a></li><li>Create Sub Sections</li>
                    <!-- end breadcrumb -->
            </div>
            <!-- END RIBBON -->
            <!-- MAIN CONTENT -->
            <div id="content">
                ...
                <form:form class="smart-form" id="subSectionsCreateForm" novalidate="novalidate" commandName="subsections" action="${pageContext.request.contextPath}/sections/create" method="post" >
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-3">
                            <section>
                                <label class="label">Sub Section Description<samp style="color: red">*</samp></label>
                                <label class="input">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-10">
                            <footer style="background-color: #ffffff">
                                <form:button type="button" class="btn btn-primary" id ="pagesubmit" disabled="${avn_create}" onclick="pageSubmit();">Save</form:button>  
                                </footer>
                            </div>
                            <div class="col-xs-1"></div>
                        </div>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                $('#subSectionsCreateForm').validate({
                    rules: {
                        subsectionDes: {
                            required: true
                        },
            ...
            function pageSubmit() {
                ...
                if ($("#subSectionsCreateForm").valid()) {
                    ...
                    $.ajax({
                        type: "post",
                        url: "${pageContext.servletContext.contextPath}/subsection/created",
                        cache: false,

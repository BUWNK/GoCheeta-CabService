<%-- 
    Document   : subsectionsearch
    Created on : Nov 26, 2015, 10:21:17 AM
    Author     : Isuru
--%>
    ...
    <body class="">
        ...
        <div id="main" role="main">
            ...
            <div id="ribbon">
                <!-- breadcrumb -->
                <ol class="breadcrumb">
                    <li><a href="${pageContext.servletContext.contextPath}/case/search">Subsection Management</a></li><li>Search Subsection</li>
                    <!-- end breadcrumb -->
                </ol>   
            </div>
            <!-- END RIBBON -->
            ...
            <div id="content">	
                ...
                <div class="row">
                    ...
                    <!-- NEW COL START -->
                    <form:form novalidate="novalidate" method="get" action="${pageContext.request.contextPath}/subsections/searched" commandName="subsectionsearch">
                            ...
                            <div class="input-group input-group-sm ">
                                <div class="input-group-btn">
                                    <form:select name = "searchoption" path="searchoption" class="btn btn-default dropdown-toggle" data-toggle="dropdown" onchange="clearTable()">
                                        <form:option value="subsectionId"  >Sub Section ID</form:option>
                                        <form:option value="subsectionDes" > Description</form:option>
                                    </form:select>
                                </div>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                var search_table = $('#dt_basic').dataTable({
                    ...
                    "sAjaxSource": "${pageContext.servletContext.contextPath}/subsection/searched",
                    "fnServerData": function (sSource, aoData, fnCallback) {
                        ...
                        $.ajax({
                            "dataType": 'json',
                            "type": "GET",
                            "url": "${pageContext.servletContext.contextPath}/subsection/searched",
                            "data": aoData,
                            "success": fnCallback
                        });
                    },

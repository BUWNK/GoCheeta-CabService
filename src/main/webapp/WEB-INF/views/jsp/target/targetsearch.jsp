                                        ...
                                        <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                                            <thead>			                
                                                <tr>
                                                    ...
                                                    <th data-hide="phone,tablet">Target Type</th>
                                                    <th data-hide="phone,tablet">Activity Type</th>
                                                    <th data-hide="phone,tablet">Target Group</th>
            ...
            $(document).ready(function () {
                ...
                var search_table = $('#dt_basic').dataTable({
                    ...
                    "aoColumns": [
                        ...
                        {"mDataProp": "tragetgroupdes", "bSortable": false},
                        {"mDataProp": "targettypedes", "bSortable": false},
                        {"mDataProp": "activitytypedes", "bSortable": false},

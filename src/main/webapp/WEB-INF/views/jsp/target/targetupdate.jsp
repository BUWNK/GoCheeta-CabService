<%-- 
    Document   : targetupdate
    Created on : May 9, 2016, 3:32:59 PM
    Author     : ISURU
--%>
    ...
    <body class="">
        ...
        <div id="main" role="main">
            ...
            <div id="content">
                ...
                <form:form class="smart-form" id="useRoleSection" novalidate="novalidate" action="${pageContext.request.contextPath}/subsections/searched" commandName="targetUpdate" method="post" >
                    <form:input path="targetid" type="text" id="tragetid"  placeholder="Customer Name" /><i></i>
                    <div class="row">
...
//                            multisectionvalidate: true
            ...
            function pageSubmit() {
                $('#msg_dev').empty();
                    ...
                    $.ajax({
                        type: "post",
                        url: "${pageContext.servletContext.contextPath}/target/updated",
                        cache: false,

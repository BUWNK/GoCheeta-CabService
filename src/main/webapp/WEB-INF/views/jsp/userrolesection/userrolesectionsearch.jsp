<%-- 
    Document   : userrolesectionsearch
    Created on : Nov 27, 2015, 9:57:47 AM
    Author     : Isuru
--%>
    ...
    <body class="">
        ...
        <div id="main" role="main">
            ...
            <div id="ribbon">
                <!-- breadcrumb -->
                <ol class="breadcrumb">
                    <li><a href="${pageContext.servletContext.contextPath}/case/search"></a>User Role Section Management</li><li>Search</li>
                    <!-- end breadcrumb -->
                </ol>   
            </div>
            <!-- END RIBBON -->
            ...
            <div id="content">	
                ...
                <div class="row">
                    ...
                    <!-- NEW COL START -->
                    <form:form class="smart-form"  novalidate="novalidate" method="get"  commandName="userrolesectionsearch">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-3">
                                <section>
                                    ...
                                    <label class="select">
                                        <form:select id="userroleid" path="userroleid" items="${userRoleList}" data-toggle="dropdown" onchange="clearTable()"/>
                                        <i></i>
                                    </label>
                                </section>
                                        ...
                                        <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                                            <thead>			                
                                                <tr>
                                                    ...
                                                    <th data-class="expand"><i class=""></i>Section</th> 
                ...
                var search_table = $('#dt_basic').dataTable({
                    ...
                    "fnServerData": function (sSource, aoData, fnCallback) {
                        ...
                        $.ajax({
                            "dataType": 'json',
                            "type": "GET",
                            "url": "${pageContext.servletContext.contextPath}/userrolesection/searched",
                            "data": aoData,
                            "success": fnCallback
                        });
                    },

<%-- 
    Document   : userrolesubsectionsearch
    Created on : Dec 1, 2015, 1:48:35 PM
    Author     : Isuru
--%>
    ...
    <body class="">
        ...
        <div id="main" role="main">
            ...
            <div id="ribbon">
                ...
                <!-- breadcrumb -->
                <ol class="breadcrumb">
                    <li><a href="${pageContext.servletContext.contextPath}/user">Role Subsection Management</a></li><li>Search</li>
                </ol>
            ...
            <div id="content">
                ...
                <form:form novalidate="novalidate" class="smart-form"  method="post" action="${pageContext.servletContext.contextPath}/" commandName="userrolesubsectionsearch" autocomplete="off">
                    <div class="row">
                        ...
                        <div class="col-xs-3">
                            <section>
                                ...
                                <label class="select">
                                    <form:select id="userroleid" path="userroleid" items="${userRoleList}"/>
                                    <i></i>
                                </label>
                            </section>
                        </div>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                var search_table = $('#dt_basic').dataTable({
                    ...
                    "sAjaxSource": "${pageContext.servletContext.contextPath}/rolesubsection/searched",
                    "fnServerData": function (sSource, aoData, fnCallback) {
                        ...
                        $.ajax({
                            "dataType": 'json',
                            "type": "GET",
                            "url": "${pageContext.servletContext.contextPath}/rolesubsection/searched",
                            "data": aoData,
                            "success": fnCallback
                        });
                    },

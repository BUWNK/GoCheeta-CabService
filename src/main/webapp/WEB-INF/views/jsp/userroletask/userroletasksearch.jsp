<%-- 
    Document   : userroletasksearch
    Created on : Dec 6, 2015, 7:29:37 PM
    Author     : Isuru
--%>
    ...
    <body class="">
        ...
        <div id="main" role="main">
            ...
            <div id="ribbon">
                ...
                <!-- breadcrumb -->
                <ol class="breadcrumb">
                    <li><a href="${pageContext.servletContext.contextPath}/user"></a>Task Management</li><li>Search</li>
                </ol>
            ...
            <div id="content">
                ...
                <form:form novalidate="novalidate" class="smart-form"  method="post" action="${pageContext.servletContext.contextPath}/" commandName="userroletasksearch" autocomplete="off">
                    <div class="row">
                        ...
                        <div class="col-xs-3">
                            <section>
                                ...
                                <label class="select">
                                    <form:select id="userroleid" path="userroleid" items="${userRoleList}" onchange="clearTable();"/>
                                    <i></i>
                                </label>
                            </section>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-10">
                            <footer style="background-color: #ffffff">
                                <form:button type="button" disabled="${avn_search}" class="btn btn-primary" id="search_btn">Search</form:button>  
                            </footer>
                        </div>
                        <div class="col-xs-1"></div>
                    </div>
                                        ...
                                        <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                                            <thead>			                
                                                <tr>
                                                    ...
                                                    <th data-class="expand"><i class="fa fa-fw fa-hand-o-up hidden-md hidden-sm hidden-xs"></i>Task</th>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                var search_table = $('#dt_basic').dataTable({
                    ...
                    "sAjaxSource": "${pageContext.servletContext.contextPath}/userroletask/searched",
                    "fnServerData": function (sSource, aoData, fnCallback) {
                        ...
                        $.ajax({
                            "dataType": 'json',
                            "type": "GET",
                            "url": "${pageContext.servletContext.contextPath}/userroletask/searched",
                            "data": aoData,
                            "success": fnCallback
                        });
                    },

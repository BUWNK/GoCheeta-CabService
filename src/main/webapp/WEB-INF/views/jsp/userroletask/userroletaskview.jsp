<%-- 
    Document   : userroletaskview
    Created on : Dec 7, 2015, 11:37:51 AM
    Author     : Isuru
--%>
    ...
    <body class="">
        ...
        <div id="main" role="main">
            ...
            <div id="ribbon">
                <!-- breadcrumb -->
                <ol class="breadcrumb">
                    <li> <a href="${pageContext.servletContext.contextPath}/">Task Management</a></li><li>View</li>
                    <!-- end breadcrumb -->
            </div>
            <!-- END RIBBON -->
            <!-- MAIN CONTENT -->
            <div id="content">
                ...
                <form:form class="smart-form" id="useRoleSection" novalidate="novalidate" action="${pageContext.request.contextPath}/subsections/searched" commandName="userroletaskview" method="post" >
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-3">
                            <section>
                                ...
                                <label class="select">
                                    <form:select id="userroleid" path="userroleid" items="${userRoleList}" disabled="true" onchange="RoleSectionList('${pageContext.servletContext.contextPath}')"/>
                                    <i></i>
                                </label>
                            </section>
                        </div>
                    ...
                    <div class="row" id="multibranchselect" style="display: ${multibranchdisplay};">
                        ...
                        <div class="col-xs-3">
                            <section>
                                ...
                                <label class="select">
                                    <form:select id="taskid" path="taskid" items="${notAssigneTask}" disabled="true" multiple="true" style="height:100px;"/>
                                </label>
                            </section>
                        </div>
                        <div class="col-xs-2">
                        ...
                        <div class="col-xs-3">
                            <section>
                                <label class="label" style="height:19px;"></label>
                                <label class="select">
                                    <form:select id="multitask" items="${assigneTask}" disabled="true" path="multitask" multiple="true" style="height:100px;"/>
                                </label>
                            </section>
                        </div>
                        <div class="col-xs-2"></div>
                ...
                <script type="text/javascript">
                    function pageSubmit() {
                        ...
                        if ($("#useRoleSection").valid()) {
                            ...
                            $.ajax({
                                type: "post",
                                url: "${pageContext.servletContext.contextPath}/userroletask/create",
                                cache: false,
                ...
                if (roleid !== '') {
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            $("#userrolesubsectionid").val("${userroletaskview.userrolesubsectionid}");
                        },
                        error: function () {
                            console.log('Error while request..');
                        }

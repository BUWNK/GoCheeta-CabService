<%-- 
    Document   : wedgetupdate
    Created on : May 4, 2016, 3:58:28 PM
    Author     : ISURU
--%>
    ...
    <body class="">
        ...
        <div id="main" role="main">
            ...
            <div id="ribbon">
                <!-- breadcrumb -->
                <ol class="breadcrumb">
                    <li> <a href="${pageContext.servletContext.contextPath}/">Wedget Management</a></li><li>Update Details</li>
                    <!-- end breadcrumb -->
            </div>
            <!-- END RIBBON -->
            <!-- MAIN CONTENT -->
            <div id="content">
                <div class="row">
                    <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
                        <h1 class="page-title txt-color-blueDark">
                            ...
                            Wedget Management Update Details
                            <span>
                ...
                <form:form class="smart-form" id="wedgetUpdateForm" novalidate="novalidate" commandName="wedgetUpdate" action="${pageContext.request.contextPath}/wedget/update" method="post" >  
                   <form:input type="hidden" id="wedgetid" path="wedgetid"/>
                    <div class="row">
        ...
        <script type="text/javascript">
            ...
            $('#pagesubmit').click(function () {
                $("#wedgetUpdateForm").valid();
            });

            function pageSubmit() {
                $('#msg_dev').empty();
                if ($("#wedgetUpdateForm").valid()) {
                    ...
                    $.ajax({
                        type: "post",
                        url: "${pageContext.servletContext.contextPath}/wedget/updated",
                        cache: false,

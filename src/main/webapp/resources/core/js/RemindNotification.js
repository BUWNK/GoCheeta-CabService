...
//                console.log(response[i].viewState);
                if (response[i].viewState === "35") {
                    ...
                    if (response[i].section === "86") {
                        content_body += '<span class = "pull-right"><a style="ntfv" href="' + response[i].contextpath + '/Notification?Id=' + response[i].sourcetabelId + '&section=' + response[i].section + '">View</a></span> '
                                + '<br><br>'
                                + '<span class = "pull-right font-xs text-muted"><i> Call Back Time ' + response[i].remindTime + '</i></span>';
                    } else if (response[i].section === "84") {
                        content_body += '<br><br>'
                                + '<span class = "pull-right font-xs text-muted"><i> Call Back Time ' + response[i].remindTime + '</i></span>';
                    }
                    content_body += '</span>'
            ...
            for (var i = 0; i < response.length; i++) {
                ...
                if (response[i].viewState === "35") {
                    content_body += '<li>'
                            ...
                            + '</em>'
                            + '<span>' + response[i].description + '</span>'
                            + '<span class = "pull-right" style="margin-left:10px"><a style="ntfd" href="' + response[i].contextpath + '/Deletenotification?Id=' + response[i].sourcetabelId + '=' + response[i].section + '">Delete</a></span><br>';
                    if (response[i].section === "86") {
                        content_body += '<span class = "pull-right"><a style="ntfv" href="' + response[i].contextpath + '/Notification?Id=' + response[i].sourcetabelId + '&section=' + response[i].section + '">View</a></span> '
                                + '<br><br>'
                                + '<span class = "pull-right font-xs text-muted"><i> Call Back Time ' + response[i].remindTime + '</i></span>';
